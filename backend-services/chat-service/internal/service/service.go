...
func (s *Service)GetMessage(ctx context.Context, id uuid.UUID) (repository.Message, error) {
	return s.Repo.GetMessage(ctx, id)

}

func (s *Service)UpdateMessage(ctx context.Context, id uuid.UUID, text string) (error) {
